...
def gen_prompt():
    ...
    data = {
        ...
        "messages": [
            ...
            {"role": "user", "content": 'Please generate one prompt for me. Just ack prompt.'},
        ]
    }
    prompt = ''
